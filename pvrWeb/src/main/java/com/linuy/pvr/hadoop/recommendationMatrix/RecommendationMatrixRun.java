package com.linuy.pvr.hadoop.recommendationMatrix;
 ...
 * @date 2021/05/27
 **/
public class RecommendationMatrixRun {
    ...
    public int run() {
        try {
            ...
            //配置任务map和reduce类
            job.setJarByClass(RecommendationMatrixRun.class);
            job.setJar("C:\\Users\\Passenger\\Documents\\IDEA\\LinuYProject\\pvrs\\pvrWeb\\target\\pvrWeb-0.0.1-SNAPSHOT.jar");
            job.setMapperClass(RecommendationMatrixMapper.class);
            job.setReducerClass(RecommendationMatrixReduce.class);
